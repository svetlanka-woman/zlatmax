    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                const rangeFrom = rangeItem.querySelector("[data-range-from]"), rangeTo = rangeItem.querySelector("[data-range-to]"), item = rangeItem.querySelector("[data-range-item]");
                ...
                rangeInputs.forEach((function(input, handle) {
                    ...
                    input.addEventListener("blur", (function() {
                        if ("" == this.value) this.value = lestValueInput; else item.noUiSlider.setHandle(handle, this.value);
                    }));
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    ...
                    slideChange: function(swiper) {
                        const fractionCurrent = document.querySelector(".fraction-control__current"), currentIndex = swiper.realIndex + 1;
        ...
        function documentActions(e) {
            const targetElement = e.target;
            const activeLink = document.querySelector("._submenu-active"), activeBlock = document.querySelector("._submenu-open");
            if (targetElement.closest("[data-parent-submenu]")) {
                const submenuId = targetElement.dataset.parentSubmenu ? targetElement.dataset.parentSubmenu : null, submenu = document.querySelector(`[data-submenu="${submenuId}"]`);
                if (submenu) {
                ...
                e.preventDefault();
            } else if (activeLink && activeLink && !targetElement.closest(".menu-catalog__submenu")) {
                activeLink.classList.remove("_submenu-active");
                activeBlock.classList.remove("_submenu-open");
            }
